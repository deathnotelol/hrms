...
if (isset($_POST['add'])) {
    ...
    $salary = $_POST['salary'];
    $sql = "INSERT INTO positions (position_name, skill_level, salary) VALUES (:position_name,:skill_level,:salary)";
    $query = $dbh->prepare($sql);
    $query->bindParam(':position_name', $positionname, PDO::PARAM_STR);
    $query->bindParam(':skill_level', $skilllevel, PDO::PARAM_STR);
                        ...
                        <div class="row">
                            <form class="col s12" name="chngpwd" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s12">
                                        <input id="departmentshortname" type="text" class="validate" autocomplete="off" name="skilllevel" required>
