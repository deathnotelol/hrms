             ...
             <div class="sidebar-profile">
                <?php
                 ...
                 <div class="sidebar-profile-image">
                     <img src="<?php echo htmlentities($result->ProfileImage) ?>" class="circle" alt="">
                 </div>
             ...
             <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                 ...
                 <li class="no-padding">
                     <?php
                        ...
                        ?>
                     <a class="waves-effect waves-grey" href="<?php echo $hasSignature ? 'attendance.php' : 'testsign.php'; ?>">
