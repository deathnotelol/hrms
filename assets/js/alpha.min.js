$(document).ready(function () {
  ...
  if (
      ...
      document
        ...
        .addEventListener("click", function () {
          ...
          document.body.classList.toggle("background--blur"),
            ...
            e.contains("material-design-hamburger__icon--to-arrow")
    ...
    $(document).mouseup(function (e) {
      ...
      $(document).keyup(function (e) {
        27 == e.keyCode &&
          ($(".search-results").fadeOut(300), $(".search input#search").blur());
      }),
      $(".search input#search").focus(function () {
        0 != $.trim($(".search input#search").val()).length &&
  ...
  $(".sidebar-account-settings:not(.show)").fadeOut(0),
    ...
    $(".button-collapse.right-sidebar-button").sideNav({ edge: "right" }),
    $(".chat-button").sideNav({ edge: "right" }),
    $(".chat-message-link").sideNav({ menuWidth: 320, edge: "right" }),
